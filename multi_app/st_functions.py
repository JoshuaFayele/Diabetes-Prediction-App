...
def load_css():
    with open("multi_app/style.css") as f:
    ...
    if icon == 'twitter-x':
        ...
        <p>
            <a href={url} class="btn btn-outline-primary btn-lg btn-block" type="button" aria-pressed="true">
                <svg xmlns="http://www.w3.org/2000/svg" width={iconsize} height={iconsize} fill="currentColor" class="bi bi-twitter-x" viewBox="0 0 16 16">
